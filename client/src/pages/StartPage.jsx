...
// we setup the startpage and navigate the user name to the lobby if they have provided a username.
const StartPage = () => {
    ...
    <div className="h-screen flex">
      <div className="bg-white shadow-2xl rounded-md flex flex-col justify-center items-center space-y-4 w-3/5 m-auto p-10">
        ...
        <div>
          ...
          />
          {message && (
            <span className="bg-red-500 p-1 text-sm inline-block mt-2 w-full text-center text-white">
              {message}
            </span>
          )}
        </div>
     ...
     py-2 px-4 font-bold hover:animate-pulse"
          >
            Connect
          </button>
        }
